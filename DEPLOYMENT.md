...
5. Add an environment variable if needed for API base URL handling on the frontend.
6. Keep [vercel.json](/Users/nagavenkatesh/Documents/untitled%20folder%202/vercel.json) for SPA route rewrites.
