...
  // ✅ Updated cart count initialization (matches ChargersPage)
  useEffect(() => {
...
  // ✅ Updated addToCart function (matches ChargersPage)
...
      } else {
        // ✅ Add smartwatch-specific properties
        updatedCart = [...currentCart, {
          id: productData.id,
...
      setCartItem(productData.title); // Show success message
...
          {/* ✅ Updated message format to match ChargersPage */}
...
      {/* Main Content */}
      {/* ✅ Added pt-24 to avoid header overlap (from ChargersPage) */}
      <div className="container mx-auto px-4 pt-24 pb-8"> 
        <div className="flex flex-col lg:flex-row gap-6">
          {/* Filters Sidebar */}
          {/* ✅ Adapted layout classes from ChargersPage for consistency */}
...
            <div className="mb-6 mt-6"> {/* ✅ Added mt-6 */}
...
              <div className="text-center py-20 bg-white rounded-2xl shadow-lg">
              {/* ✅ Replaced SVG with text for simplicity (can keep SVG if preferred) */}
...
                      className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden animate-fadeInUp hover:-translate-y-2"
                      // ✅ Removed inline style, animation is now in CSS
                    >
                    {/* ✅ Fixed route to /smartwatches/:id */}
...
          _                   <span>{smartwatch.displayType}</span>
                            </li>
                  s         <li className="flex justify-between">
...
      {/* ✅ Using <style jsx> for animations (as in original) */}
      <style jsx>{`
        @keyframes fadeInUp {
