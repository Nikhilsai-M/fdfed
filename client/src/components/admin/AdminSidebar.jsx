...
import logo from "../../assets/images/icons/logo1.png"; // Ensure this path is correct
...
export default function AdminSidebar() {
    ...
    const location = useLocation(); // To dynamically determine the active path
    const currentPath = location.pathname;

    // The robust handleLogout function:
    const handleLogout = async () => {
        try {
            // Use the relative path (Vite Proxy)
            ...
            if (data.success) {
                // Navigate to the correct Sign In route
                navigate('/sign-in'); 
            } else {
